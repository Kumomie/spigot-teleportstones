...
public class CommandDelete extends CustomCommand {

    public CommandDelete(App app) {
        super(app, "delete");
    }
    ...
    boolean execute(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (deleter.delete(oTeleportStone.get()))
            getMessenger().sendMessage(sender, deleter.getStatusMessage(), ChatColor.GREEN);
        else
    ...
    String customDescription() {
        return //
        "Delete the choosen TeleportStone.";
    }
